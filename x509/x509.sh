...
openssl req \
    ...
    -out ca/ca_cert.pem \
    -subj "/C=CN/ST=CD State/L=CD City/O=CD Inc./CN=ca.example.com"
...
openssl req -new \
    ...
    -subj "/C=CN/ST=CD State/L=CD City/O=CD Inc./CN=server.tls.example.com"
...
openssl req -new \
    ...
    -subj "/C=CN/ST=CD State/L=CD City/O=CD Inc./CN=client.tls.example.com"
